...
type User = { image?: string | null; imageStorageId?: string | null; name?: string | null; email?: string | null };
  ...
  const showOptions = useCallback(() => {
    ...
    if (Platform.OS === 'ios') {
      ...
      Alert.alert('Profile Photo', 'Choose an option', [
        ...
        ...(hasImage ? [{ text: 'Remove Photo', style: 'destructive' as const, onPress: removeAvatar }] : []),
