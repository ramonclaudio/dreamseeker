  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={styles.content}>
        ...
        <ThemedText type="title" style={styles.title}>Early Access Features</ThemedText>
...
const styles = StyleSheet.create({
  ...
  description: { textAlign: 'center', fontSize: 16, lineHeight: 24, marginBottom: 32, paddingHorizontal: 16 },
  featureList: { width: '100%', borderTopWidth: 1, paddingTop: 24, gap: 16 },
