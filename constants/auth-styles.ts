...
export const authStyles = StyleSheet.create({
  ...
  input: { height: 44, borderRadius: Radius.md, borderCurve: 'continuous', borderWidth: 1, paddingHorizontal: 12, fontSize: 16 },
  button: { height: 44, borderRadius: Radius.md, borderCurve: 'continuous', alignItems: 'center', justifyContent: 'center', marginTop: 8 },
